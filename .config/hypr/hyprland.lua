...
hl.env("XCURSOR_THEME", "Adwaita-dark")
...
hl.bind("SUPER + S", hl.dsp.exec_cmd("uwsm-app -- google-chrome-stable"))
hl.bind("SUPER + I", hl.dsp.exec_cmd("uwsm-app -- google-chrome-stable --incognito"))
hl.bind("SUPER + B", hl.dsp.exec_cmd("uwsm-app -- google-chrome-beta"))
hl.bind("SUPER + D", hl.dsp.exec_cmd("uwsm-app -- google-chrome-unstable"))
hl.bind("SUPER + C", hl.dsp.exec_cmd("uwsm-app -- google-chrome-canary"))
...
hl.bind("SUPER + V", function()
    ...
    if project ~= "" then
        hl.dispatch(hl.dsp.exec_cmd(
            "uwsm-app -- sh -c 'for d in \"$HOME/dev/" .. project
            .. "\" \"$HOME/.local/" .. project
...
hl.bind("SUPER + A", hl.dsp.exec_cmd("uwsm-app -- alacritty msg create-window --class float-window --command alsamixer"))
